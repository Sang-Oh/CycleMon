 ...
 * 
 * $Header: /repository/Support_Utilities/ANT_NET/ANT_Scanning_Channel_Demo/Scanning_Channel_Demo/ant_dll.h,v 1.2 2009/06/26 16:15:19 canotinoco Exp $
 *
 **************************************************************************
 *
 * Not all functions available in the DLL are imported into this example. Please see
 * ANT Library source code ant.h for a complete list of available functions.
 * 
 **************************************************************************
 */
